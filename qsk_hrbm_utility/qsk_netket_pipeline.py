...
def netket_pipeline(n_fermions, model, sampler, op, vstate, optimizer, iter_num, exact_E, holomorphic=True, 
    ...
    energy_per_fermion = stats.mean.real / n_fermions
    ...
    print(f"Energy per Fermion: {energy_per_fermion:.6f}")
    if 'Ee' in globals():
