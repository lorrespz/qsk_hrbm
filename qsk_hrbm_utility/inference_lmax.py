...
def define_model_load_vstate(N, hi, seed_qsk, alpha, seed_nqs, Lmax, base_dir="."):
...
def evaluate_and_export_energies(
    N, alpha, seed_qsk_list, seed_nqs_list, Lmax, base_dir=".", save_dir=None
):
    ...
    csv_path = f"{save_dir}/qsk_N={N}_Lmax={Lmax}_energy_metrics.csv"
...
def entanglement_extraction(
    ...
    metrics_csv_path = f"{save_dir}/qsk_N={N}_Lmax={Lmax}_entanglement_metrics.csv"
    spectra_csv_path = f"{save_dir}/qsk_N={N}_Lmax={Lmax}_entanglement_spectra.csv"
...
def plot_spectrum_from_csv(N, Lmax, data_dir=None, save_dir=None):
    ...
    csv_path = f"{data_dir}/qsk_N={N}_Lmax={Lmax}_entanglement_spectra.csv"
    ...
    plt.tight_layout()
    output_path = f"{save_dir}/qsk_N={N}_Lmax={Lmax}_multi_seed_comparison.png"
